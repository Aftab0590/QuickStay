...
justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.5)] p-6 rounded-xl
mx-auto mt-16 max-w-14xl'>
...
<div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
  ...
  {/*Check in Time*/}
  <div className='flex flex-col'>
    <label htmlFor="CheckInTime" className='font-medium'>Check-InTime</label>
    <input type="Time" id='CheckInTime'  placeholder='Check-InTime'
    className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5
    outline-none' />
  </div>
  ...
  {/*Check Out Time*/}
  <div className='flex flex-col'>
    <label htmlFor="CheckOutTime" className='font-medium'>Check-OutTime</label>
    <input type="Time" id='CheckOutTime'  placeholder='Check-OutTime'
    className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5
    outline-none' />
  </div>
...
<div>
  ...
  active:scale-95 transition-all text-white rounded-md max-wd:w-full
...
<div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
  <p> Guess will be allocated on the ground floor according to availibility.
    ...
    grond floor according to Availability. You get the comfortable teo bedroom
    appartment that has a true city feeling
  </p>
</div>
