...
function Hero() {
  return (
    <div className='flex flex-col items-start justify-center px-6 md :px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-cover bg-center h-screen'>
      ...
      <h1 className='font-playfair text-2xl md:text-5xl md:txt-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>Discover Your Perfect Destination</h1>
      <p className='max-w-130 mt-2 text-sm md:text-base'>Experience the pinnacle of luxury and comfort at our world-class hotel. 
        From elegant rooms to exceptional service, we redefine hospitality.</p>
