...
function FeatureDestinaton() {
  ...
  From serene beaches to bustling cities, find your perfect destination and create memories that last a lifetime '/>
    ...
    <button  onClick={()=> {navigate ('/rooms'); scrollTo(0,0)}}
        className='my-16 px-4 py-2 text-sm font-medium border border-gray-300 rounded bg-white hover:bg-gray-200 transition-all cursor-pointer'>
...
export default FeatureDestinaton
